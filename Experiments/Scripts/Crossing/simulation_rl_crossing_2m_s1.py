...
LASER_FIELD_CONFIG = 2  # 0 = none, 1 = small fields, 2 = big fields # PLEASE EDIT
PORT = 24000  # PLEASE EDIT
REPORT_NUM = 4  # PLEASE EDIT
RANDOM_SEED = 1  # PLEASE EDIT
ACCUMULATE_REWARDS = False # if True, the reward is accumulated over the episode, if false, the maximum reward is returned at the end of the episode
...
class CoppeliaSim(gym.Env):
    ...
    def __init__(self, render, spawn, port_num=23000):
        ...
        self.observation_space = spaces.Box(low=np.array([
            ...
            high=np.array([
                11,  # workerState max-x
                11,  # workerState max-y
